...
//     echo '<input type="checkbox" name="display_options[]" value="'.$row['id'].'"> '.$row['full_name'].'<br>';
// }
// ?> -->
...
<br>
                        ...
                        <input type="checkbox" name="display_options[]" value="extension"> Extension/Accreditation<br>

...
$full_names = "19"; #change name if want to change user profile
...
if (isset($_POST['edit2'])) {
 ...
 $uploadDir =  "img/" . $file_name; // actual server path
    ...
    echo "<script>alert('✅ Profile updated successfully!');document.location='cabanal_kristianjay.php';</script>";
}

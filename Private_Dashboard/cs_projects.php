...
<!-- Heading -->
<div class="">
    <a href="add_file.php?page=cs_projects"><button type="button" class="btn btn-success"><i class="fas fa-file-medical"></i> Add File</button></a>
</div>
    ...
    <table id="dtable" class="table table-striped">
        ...
        <tbody>
            ...
            while ($file = mysqli_fetch_array($query)) {
                ...
                if (is_array($display_options) && in_array('cs_projects', $display_options)) {
                    $id = $file['ID'];
                    $name = $file['NAME'];
                    $size = $file['SIZE'];
                    $uploads = $file['EMAIL'];

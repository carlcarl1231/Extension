...
$full_names = "32"; #change name if want to change user profile
...
if (isset($_POST['edit2'])) {
 ...
 $uploadDir =  "img/" . $file_name; // actual server path
    ...
    echo "<script>alert('✅ Profile updated successfully!');document.location='fuentes_matyrollane.php';</script>";
}

...
?>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="<?php echo $path; ?>">
  <!-- Font Awesome -->
      ...
      <div class="container-fluid">
        ...
        <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-expanded="false">COLLEGE COURSES</a>
                ...
                <div class="dropdown-menu ">
                  ...
                  <a class="dropdown-item dropdown-toggle" href="#">BindTech</a>
                    <div class="dropdown-menu">
                  ...
                  <div class="dropdown-divider"></div>
                   ...
                   <div class="dropdown-submenu">
                  <a class="dropdown-item dropdown-toggle" href="#">BTVTE</a>
                  <div class="dropdown-menu">
              ...
              <!-- <ul class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="evangelista_cirilo.php" >Evangelista, Cirilo C.</a>
                  <div class="dropdown-divider"></div>
...
<!--end modaluser-->
 ...
 <div id="loader"></div>
  ...
  <h4 class="mb-2 mb-sm-0 pt-1">
    <a href="#" style="color: green;"><b>FACULTY</b></a>
  </h4>
</div>

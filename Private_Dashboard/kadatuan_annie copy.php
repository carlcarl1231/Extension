...
<div class="">
     <?php
         require_once("include/connection.php");
            ...
            $query="SELECT * FROM profiles WHERE full_name='$full_names'";
  ...
  <div class="card custom-card">
   ...
   <img id="profileImg" 
     ...
     style="width:120px; height:120px; border-radius:50%; object-fit:cover;">
      ...
      <h1 id="nameDisplay"><?php echo $full_name; ?></h1>
    </div>
...
$full_names = "AME"; #change name if want to change user profile
$q = mysqli_query($conn, "SELECT * FROM profiles WHERE full_name = '$full_names' LIMIT 1") 
...
if (isset($_POST['edit2'])) {
 ...
 $uploadDir =  "img/" . $file_name; // actual server path
    ...
    echo "<script>alert('✅ Profile updated successfully!');document.location='kadatuan_annie.php';</script>";
}

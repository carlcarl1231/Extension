...
if (isset($_POST['save'])) { // if save button on the form is clicked
    ...
    if (!in_array($extension, ['pdf', 'docx', 'jpg'])) {
        ...
        $query = mysqli_query($conn, "SELECT * FROM `private_files` WHERE `name` = '$filename'") or die(mysqli_error($conn));
...
$time = date("Y-m-d H:i:s"); // Save in correct format for sorting

...
$full_names = "15"; #change name if want to change user profile
...
if (isset($_POST['edit2'])) {
 ...
 $uploadDir =  "img/" . $file_name; // actual server path
    ...
    echo "<script>alert('✅ Profile updated successfully!');document.location='talua_glenn.php';</script>"; /*redirection changes base on clicked faculty*/
}

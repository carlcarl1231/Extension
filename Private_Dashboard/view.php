...
if (isset($_GET['id'])) {
    $id = intval($_GET['id']); // ensures it's numeric and safe
...
<form id="profileForm" enctype="multipart/form-data">
  <div class="card custom-card">
    <div class="card-header">
      ...
      <!-- 👇 you can replace fullname with ID if you want -->
      <h1 id="nameDisplay" class="name-display">
        <?php echo $full_name; ?> <!-- or use $full_name -->
      </h1>
    </div>
    ...
    <div class="two-columns">
      <div class="column" id="detailsDisplay">
        ...
        <p id="degree1Text"><?php echo htmlspecialchars($degree1); ?></p>
        <p id="degree2Text"><?php echo htmlspecialchars($degree2); ?></p>
        <p id="degree3Text"><?php echo htmlspecialchars($degree3); ?></p>
        <p id="degree4Text"><?php echo  htmlspecialchars($degree4); ?></p>
        <p id="degree5Text"><?php echo htmlspecialchars($degree5); ?></p>
        <p class="title">---------------</p>
        ...
        <td align='center'>
          ...
          | 
          <a href="delete_faculty.php?id=<?php echo htmlentities($id); ?>">
    ...
    <table id="dtable" class="table table-striped">
        ...
        <tbody>
            ...
            while ($file = mysqli_fetch_array($query)) {
                ...
                if (is_array($display_options) && in_array($filename, $display_options)) {
                    $id = $file['ID'];
                    $name = $file['NAME'];
                    $size = $file['SIZE'];
                    $uploads = $file['EMAIL'];
...
if (isset($_GET['id'])) {
    ...
    // default values to prevent undefined warnings
    $id1 = $full_name1 = $degree11 = $degree21 = $degree31 = $degree41 = $degree51 = "";

    $q = mysqli_query($conn, "SELECT * FROM profiles WHERE id = '$id' LIMIT 1") 
         or die(mysqli_error($conn));

    if ($rs1 = mysqli_fetch_assoc($q)) {
        $id1        = $rs1['id'];
        $full_name1 = $rs1['full_name'];
        $degree11   = isset($rs1['degree1']) ? $rs1['degree1'] : "";
        $degree21   = isset($rs1['degree2']) ? $rs1['degree2'] : "";
        $degree31   = isset($rs1['degree3']) ? $rs1['degree3'] : "";
        $degree41   = isset($rs1['degree4']) ? $rs1['degree4'] : "";
        $degree51   = isset($rs1['degree5']) ? $rs1['degree5'] : "";  

    } else {
        echo "❌ No profile found for ID: $id";
    }
}
...
?>
  ...
  <input type="file" id="orangeForm-file" name="profile_image" class="form-control">
        ...
        <div class="md-form mb-5">
          ...
          <label data-error="wrong" data-success="right" for="orangeForm-name">Bachelor Degree</label>
        </div>

        <div class="md-form mb-4">
          <i class="fas fa-graduation-cap prefix grey-text"></i>
          <input type="text" id="orangeForm-name" name="degree2" value="<?php echo $degree21;?>" class="form-control validate">
          <label data-error="wrong" data-success="right" for="orangeForm-name">Master Degree</label>
        </div>
        <div class="md-form mb-4">
          <i class="fas fa-graduation-cap prefix grey-text"></i>
          <input type="text" id="orangeForm-name" name="degree3" value="<?php echo $degree31;?>" class="form-control validate">
          <label data-error="wrong" data-success="right" for="orangeForm-name">Doctors Degree</label>
        </div>
        <div class="md-form mb-4">
          <i class="fas fa-graduation-cap prefix grey-text"></i>
          <input type="text" id="orangeForm-name" name="degree4" value="<?php echo $degree41;?>" class="form-control validate">
          <label data-error="wrong" data-success="right" for="orangeForm-name">Elegibility</label>
        </div>
        <div class="md-form mb-4">
          <i class="fas fa-graduation-cap prefix grey-text"></i>
          <input type="text" id="orangeForm-name" name="degree5" value="<?php echo $degree51;?>" class="form-control validate">
          <label data-error="wrong" data-success="right" for="orangeForm-name">Others</label>
        </div>
          <!-- <div class="md-form mb-4">
          <i class="fas fa-user prefix grey-text"></i>
...
echo "<script>alert('✅ Profile updated successfully!');document.location='view.php?id=$id';</script>";

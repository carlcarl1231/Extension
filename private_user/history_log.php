...
<!--Navbar -->
<nav class="mb-1 navbar navbar-expand-lg navbar-dark bg-success fixed-top">
    <a class="navbar-brand" href="#"><img src="../img/sksulogo.png" width="33px" height="33px"> <font color="#FFFF00">SKSU EXTENSION OFFICE MANAGEMENT SYSTEM</font></a>
...
<div class="tab-content pt-2 pl-1" id="pills-tabContent">
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
    ...
    <div class="">
     ...
     <div class=""><p><b style="font-size: 1.1em">Full Name:</b>TUNDAG & FRANCO</p></div>

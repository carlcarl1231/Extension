...
<div class="tab-content pt-2 pl-1" id="pills-tabContent">
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
    <img src="../sksulogo.png" class="rounded" alt="..."><hr>
    <div class="">
     
     <div class=""><p><b style="font-size: 1.1em">Name:</b>TUNDAG & FRANCO</p></div>
     <div class=""><p><b style="font-size: 1.1em">Position:</b>Future Engineers</p></div>

  </div>
  <hr>
  </div>
  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
   <h6 style="font-size: 1.1em">Extension Services Office</h6><Hr>
   The SKSU is mandated to discharge extension functions to support its primordial mission of offering professional 
   and technical training in science and technology, literature, philosophy, and arts and science. The University’s 
   Extension Division endeavors to become a steady presence in the dissemination and promotion of technologies, knowledge, 
   and skills to the communities in Region XII. Towards this end, the Division has clearly defined its fundamental philosophy,
    the areas of concern, and the organization and the implementing mechanisms. When these elements are well defined, Extension
     activities can be effectively and efficiently operationalized and its vision of establishing a proactive role in extension 
     services can be easily and sustainably attained.
  </div>
...
<div class="card" style="border-top: 4px solid #17a2b8;border-radius: 4px;">
  ...
  <div class="card-body">
    ...
    <!-- Title -->
    <h4 class="card-title">SKSU EXTENSION OFFICE DOCS</h4><hr>
    <!-- Text -->
<!--
    <ul>
      <li> <p></p></li>
